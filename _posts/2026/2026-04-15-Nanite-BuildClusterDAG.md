---
layout: post
title:  "Nanite - Build Cluster DAG"
date:   2026-04-15 20:18:00 +800
category: Unreal Engine
---

- [1. 构建 Leaf Cluster](#1-构建-leaf-cluster)
  - [1.1. 为每条有向 Triangle Edge 建 Hash](#11-为每条有向-triangle-edge-建-hash)
  - [1.2. 找共享边并建立三角形邻接信息](#12-找共享边并建立三角形邻接信息)
  - [1.3. 构建 Triangle 连通岛](#13-构建-triangle-连通岛)
  - [1.4. METIS 递归二分所有 Triangle](#14-metis-递归二分所有-triangle)
  - [1.5. 根据分区结果创建 Leaf Cluster](#15-根据分区结果创建-leaf-cluster)
- [2. 构建 Cluster DAG](#2-构建-cluster-dag)
  - [2.1. Group 怎么划分](#21-group-怎么划分)
  - [2.2. **Reduce** Group](#22-reduce-group)
    - [2.2.1. Merge](#221-merge)
    - [2.2.2. Simplify](#222-simplify)
    - [2.2.3. Split](#223-split)
  - [2.3. 总结 Nanite 构建 Cluster DAG](#23-总结-nanite-构建-cluster-dag)
...
### 1.1. 为每条有向 Triangle Edge 建 Hash
